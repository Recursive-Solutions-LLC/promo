...
exports.default = series(
    html,
    vendor,
    parallel( fonts, images, javascript, style, icons),
    parallel(imagesCompression, watchFiles, initBrowserSync)
);
...
exports.build = series(
    ...
    html,
    vendor,
    parallel( fonts, imagesCompression, javascript, style, icons)
);

// Agrega una tarea `dev` que ejecuta las tareas necesarias para el desarrollo
exports.dev = series(
    clean,
    html,
    vendor,
...
// Agrega una tarea `build` que ejecuta las tareas necesarias para la producción
exports.build = series(
    clean,
    html,
    vendor,
